...
public class Utils
{
  ...
  /**
   * Determines if ImageIO supports the newImage type of this file and returns a
   * String with the status information.  The String starts with "Supported"
   * if the file is supported or is a longer string including suggestions if it
   * is not.  
   * 
   * @param file
  ...
  /**
   * Convenience function to determine if ImageIO supports the newImage type
   * of this file.  Calls getImageIOSupportedStatus(file) and checks the
   * String returned to determine if the file is supported or not.
   * @param file
  ...
  public static void warnMsg(String msg) {
    // Show it in a message box
    JOptionPane
      .showMessageDialog(null, msg, "Warning", JOptionPane.WARNING_MESSAGE);
    System.out.println(msg);
  }
